...
export default function Work() {
  return (
    <>
      ...
      seen everywhere and in everything.
      <br /><br />
      I don't have a client to work on yet, currently just dropping a bunch
      of artworks. Any types of artworks that I enjoy making on. Dropping
      lots of works on August hopefully
      <br /><br />
      This TAB is currently ongoing maintenance. I'll be adding subcategories
